...
def main():
	...
	train = generator.flow_from_directory('/Upload_Floyd/',
										target_size = (512, 512),
										batch_size = 10,
	...
	model.add(Conv2D(64, (whatByWhatStridesBox, whatByWhatStridesBox), activation='relu', input_shape=(512, 512, 3), padding = 'same'))
	...
	model.add(Conv2D(16, (whatByWhatStridesBox, whatByWhatStridesBox), activation='relu', input_shape=(256, 256, 3),  padding = 'same'))
	model.add(Conv2D(16, (whatByWhatStridesBox, whatByWhatStridesBox), activation='relu', input_shape=(256, 256, 3),  padding = 'same'))
	model.add(MaxPool2D(pool_size=(2, 2)))
	model.add(Activation('relu'))
	...
	checkpoint = ModelCheckpoint("/output/faces_MLmodel_checkpoint.hdf5", save_best_only = True, mode = "max")
